...
class getRouting_LoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'carlos-mg89'.\DIRECTORY_SEPARATOR.'symfony-captcha-bundle'.\DIRECTORY_SEPARATOR.'Routing'.\DIRECTORY_SEPARATOR.'CaptchaRoutesLoader.php';
        ...
        $b->addLoader(new \Captcha\Bundle\CaptchaBundle\Routing\CaptchaRoutesLoader());
        $b->addLoader($e);
