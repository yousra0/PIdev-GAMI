...
class getApiPlatform_IriConverter_LegacyService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = ($container->privates['debug.api_platform.item_data_provider'] ?? $container->getDebug_ApiPlatform_ItemDataProviderService());

        if (isset($container->privates['api_platform.iri_converter.legacy'])) {
            return $container->privates['api_platform.iri_converter.legacy'];
        }
        $c = ($container->privates['debug.api_platform.subresource_data_provider'] ?? $container->getDebug_ApiPlatform_SubresourceDataProviderService());

        if (isset($container->privates['api_platform.iri_converter.legacy'])) {
            return $container->privates['api_platform.iri_converter.legacy'];
        }
        $d = ($container->privates['api_platform.identifier.converter'] ?? $container->getApiPlatform_Identifier_ConverterService());

        if (isset($container->privates['api_platform.iri_converter.legacy'])) {
            return $container->privates['api_platform.iri_converter.legacy'];
        }
        $e = ($container->privates['api_platform.router'] ?? $container->getApiPlatform_RouterService());

        return $container->privates['api_platform.iri_converter.legacy'] = new \ApiPlatform\Core\Bridge\Symfony\Routing\IriConverter(($container->privates['api_platform.metadata.property.name_collection_factory.cached'] ?? $container->getApiPlatform_Metadata_Property_NameCollectionFactory_CachedService()), $a, $b, new \ApiPlatform\Core\Bridge\Symfony\Routing\CachedRouteNameResolver(($container->privates['api_platform.cache.route_name_resolver'] ?? $container->getApiPlatform_Cache_RouteNameResolverService()), new \ApiPlatform\Core\Bridge\Symfony\Routing\RouteNameResolver($e)), $e, ($container->privates['property_accessor'] ?? $container->getPropertyAccessorService()), ($container->privates['api_platform.identifiers_extractor.cached'] ?? $container->getApiPlatform_IdentifiersExtractor_CachedService()), $c, $d, ($container->privates['api_platform.resource_class_resolver'] ?? $container->getApiPlatform_ResourceClassResolverService()), ($container->privates['api_platform.metadata.resource.metadata_factory.cached'] ?? $container->getApiPlatform_Metadata_Resource_MetadataFactory_CachedService()));
    }
}
